        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input id="username" name="username" type="text" required 
                    value="{{ old('username') }}"
                    class="mt-1 block w-full px-3 py-2 border {{ $errors->has('username') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" 
            ...
            <div>
                ...
                <input id="email" name="email" type="email" required 
                    value="{{ old('email') }}"
                    class="mt-1 block w-full px-3 py-2 border {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" 
            ...
            <div>
                ...
                <div class="mt-1 relative">
                    <input id="password" name="password" :type="showPassword ? 'text' : 'password'" required 
                        ...
                        class="block w-full px-3 py-2 border {{ $errors->has('password') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" 
            ...
            <div class="flex items-center">
                <input id="terms" name="terms" type="checkbox" required
                    class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 {{ $errors->has('terms') ? 'border-red-500' : 'border-gray-300' }} rounded">
