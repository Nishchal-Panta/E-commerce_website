        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
                ...
                <img src="<?php echo e(asset('storage/' . $item->product->getPrimaryImage()->image_path)); ?>" 
                    class="w-full sm:w-24 h-32 sm:h-24 object-cover rounded-lg" alt="<?php echo e($item->product->name); ?>">
                <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-2 w-full sm:w-auto">
                    <form action="<?php echo e(route('buyer.cart.update', $item->id)); ?>" method="POST" class="flex items-center justify-center gap-2">
                        <?php echo csrf_field(); ?>
                ...
                <div class="text-right">
                    ...
                    <form action="<?php echo e(route('buyer.cart.destroy', $item->id)); ?>" method="POST" class="w-full sm:w-auto">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/resources/views/buyer/cart.blade.php ENDPATH**/ ?>