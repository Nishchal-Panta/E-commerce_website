...
<div class="container mx-auto px-4 py-8">
    ...
    <?php if($orders->isEmpty()): ?>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-12 text-center">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="inline-block bg-primary-600 hover:bg-primary-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200">
                Start Shopping
            </a>
        </div>
    <?php else: ?>
                    ...
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <a href="<?php echo e(route('buyer.orders.show', $order->id)); ?>" 
    ...
    <div class="flex-1">
        <h4 class="font-medium text-gray-900 dark:text-white"><?php echo e($item->product->name); ?></h4>
    ...
    <div class="text-right">
        <p class="font-semibold text-gray-900 dark:text-white">
            $<?php echo e(number_format($item->price_at_purchase, 2)); ?>
                            ...
                            <?php if($order->orderItems->count() > 3): ?>
                                <p class="text-sm text-gray-600 dark:text-gray-400 text-center">
                                    + <?php echo e($order->orderItems->count() - 3); ?> more <?php echo e(Str::plural('item', $order->orderItems->count() - 3)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/resources/views/buyer/orders.blade.php ENDPATH**/ ?>