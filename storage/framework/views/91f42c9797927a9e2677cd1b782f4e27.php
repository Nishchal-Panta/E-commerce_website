...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="text-sm mb-6">
        <ol class="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
            ...
            <li><a href="<?php echo e(route('products.index')); ?>" class="hover:text-primary-600">Products</a></li>
            <li><span class="mx-2">/</span></li>
            <li class="text-gray-900 dark:text-white font-medium"><?php echo e($product->name); ?></li>
        </ol>
    </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4">
                    <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" 
                             alt="<?php echo e($product->name); ?>"
                             @click="activeImage = '<?php echo e(asset('storage/' . $image->image_path)); ?>'"
                             :class="activeImage === '<?php echo e(asset('storage/' . $image->image_path)); ?>' ? 'ring-2 ring-primary-500' : ''"
        ...
        <script>
            function imageZoom() {
                return {
                    activeImage: '<?php echo e($product->primaryImage ? asset('storage/' . $product->primaryImage->image_path) : ''); ?>',
                    showModal: false,
                    scale: 1,
                    translateX: 0,
                    translateY: 0,
        ...
        <!-- Product Details -->
        <div>
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4"><?php echo e($product->name); ?></h1>
                ...
                <?php if($product->getAverageRating() > 0): ?>
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-lg text-gray-600 dark:text-gray-400">
                            <?php echo e(number_format($product->getAverageRating(), 1)); ?> (<?php echo e($product->reviews->count()); ?> <?php echo e(Str::plural('review', $product->reviews->count())); ?>)
                        </span>
                    </div>
                <?php else: ?>
                ...
                <?php if($product->inventory_quantity > 0): ?>
                    <?php if($product->isLowStock()): ?>
                        <span class="inline-flex items-center px-4 py-2 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded-full">
                            ...
                            Only <?php echo e($product->inventory_quantity); ?> left in stock!
                        </span>
                    <?php else: ?>
                        <span class="inline-flex items-center px-4 py-2 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full">
                            ...
                            In Stock (<?php echo e($product->inventory_quantity); ?> available)
                        </span>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <div class="mb-6 space-y-3">
                <?php if($product->brand): ?>
                    <p class="text-gray-700 dark:text-gray-300">
                        <span class="font-semibold">Brand:</span> <?php echo e($product->brand); ?>

                    </p>
                <?php endif; ?>
                <?php if($product->category): ?>
                    <p class="text-gray-700 dark:text-gray-300">
                        <span class="font-semibold">Category:</span> <?php echo e($product->category); ?>

                    </p>
                <?php endif; ?>
                <?php if($product->color): ?>
                    <p class="text-gray-700 dark:text-gray-300">
                        <span class="font-semibold">Color:</span> <?php echo e($product->color); ?>

                    </p>
                <?php endif; ?>
                <?php if($product->size): ?>
                    <p class="text-gray-700 dark:text-gray-300">
                        <span class="font-semibold">Size:</span> <?php echo e($product->size); ?>
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-700 dark:text-gray-300 leading-relaxed"><?php echo e($product->description); ?></p>
            </div>

            <!-- Add to Cart Form -->
            <?php if(auth()->guard()->check()): ?>
                <form action="<?php echo e(route('buyer.cart.add')); ?>" method="POST" x-data="{ quantity: 1 }" class="mb-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg">
                            ...
                            <input type="number" name="quantity" x-model="quantity" min="1" max="<?php echo e($product->inventory_quantity); ?>"
                                   class="w-20 text-center border-x border-gray-300 dark:border-gray-600 py-2 dark:bg-gray-800 dark:text-white">
                            <button type="button" @click="quantity = Math.min(<?php echo e($product->inventory_quantity); ?>, quantity + 1)" 
                                    class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="block w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-4 px-6 rounded-lg transition duration-200 text-center text-lg">
                    Login to Purchase
                </a>
            <?php endif; ?>
            ...
            <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                ...
                <p class="text-gray-700 dark:text-gray-300"><?php echo e($product->seller->username); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="text-center">
                        <div class="text-6xl font-bold text-gray-900 dark:text-white mb-2">
                            <?php echo e(number_format($product->getAverageRating(), 1)); ?>
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Based on <?php echo e($product->reviews->count()); ?> <?php echo e(Str::plural('review', $product->reviews->count())); ?></p>
                    </div>

                    <div>
                        <?php $breakdown = $product->getRatingBreakdown(); ?>
                        <?php $__currentLoopData = [5,4,3,2,1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center mb-2">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 w-12"><?php echo e($star); ?> star</span>
                                <div class="flex-1 mx-4">
                                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                        <div class="bg-yellow-400 h-2 rounded-full" style="width: <?php echo e($breakdown[$star]); ?>%"></div>
                                    </div>
                                </div>
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 w-12 text-right"><?php echo e($breakdown[$star]); ?>%</span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <?php $__currentLoopData = $product->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white"><?php echo e($review->buyer->username); ?></h4>
                            ...
                            <div class="flex items-center space-x-4">
                                <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($review->created_at->format('M d, Y')); ?></span>
                                
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if($review->buyer_id === auth()->id()): ?>
                                        <div class="flex space-x-2">
                                            <a href="<?php echo e(route('buyer.reviews.edit', $review->id)); ?>" 
                                               class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                            </a>
                                            <form action="<?php echo e(route('buyer.reviews.destroy', $review->id)); ?>" method="POST" 
                        ...
                        <?php if($review->comment): ?>
                            <p class="text-gray-700 dark:text-gray-300 mb-4"><?php echo e($review->comment); ?></p>
                        <?php endif; ?>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                                <?php $__currentLoopData = $review->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img src="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" 
                                         alt="Review photo" 
                                         @click="currentImage = '<?php echo e(asset('storage/' . $photo->photo_path)); ?>'; showModal = true"
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->user()->hasPurchased($product->id) && !auth()->user()->reviews()->where('product_id', $product->id)->exists()): ?>
                <div class="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6" x-data="{ showReviewForm: false, rating: 0 }">
                    ...
                    <div x-show="showReviewForm" 
                        ...
                        <form action="<?php echo e(route('buyer.reviews.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="product_id" value="<?php echo e($product->id); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php elseif(auth()->user()->reviews()->where('product_id', $product->id)->exists()): ?>
            ...
            <?php elseif(!auth()->user()->hasPurchased($product->id)): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/resources/views/buyer/product-detail.blade.php ENDPATH**/ ?>