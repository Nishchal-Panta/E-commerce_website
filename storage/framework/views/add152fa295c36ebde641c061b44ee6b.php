...
<?php $__env->startSection('title', 'Report an Issue'); ?>
            ...
            <form action="<?php echo e(route('report.store')); ?>" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select id="report_type" name="report_type" required
                            class="w-full px-4 py-2 border <?php echo e($errors->has('report_type') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?> rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white">
                        <option value="">Select issue type...</option>
                        <option value="bug" <?php echo e(old('report_type') == 'bug' ? 'selected' : ''); ?>>🐛 Bug Report</option>
                        <option value="technical_issue" <?php echo e(old('report_type') == 'technical_issue' ? 'selected' : ''); ?>>⚙️ Technical Issue</option>
                        <option value="feature_request" <?php echo e(old('report_type') == 'feature_request' ? 'selected' : ''); ?>>💡 Feature Request</option>
                        <option value="improvement" <?php echo e(old('report_type') == 'improvement' ? 'selected' : ''); ?>>🚀 Improvement Suggestion</option>
                        <option value="other" <?php echo e(old('report_type') == 'other' ? 'selected' : ''); ?>>📝 Other</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="title" name="title" value="<?php echo e(old('title')); ?>" required
                           ...
                           class="w-full px-4 py-2 border <?php echo e($errors->has('title') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?> rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="8" required
                              ...
                              class="w-full px-4 py-2 border <?php echo e($errors->has('description') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'); ?> rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-blue-800 dark:text-blue-300">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>You'll receive updates via email at <?php echo e(auth()->user()->email); ?></li>
        ...
        <?php if(auth()->user()->bugReports->isNotEmpty()): ?>
            <div class="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Your Recent Reports</h2>
                <div class="space-y-3">
                    <?php $__currentLoopData = auth()->user()->bugReports->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div class="flex-1">
                                <h3 class="font-medium text-gray-900 dark:text-white"><?php echo e($report->title); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Downloads\laravel_project\resources\views/buyer/report-issue.blade.php ENDPATH**/ ?>