...
<?php $__env->startSection('title', 'FAQ - Frequently Asked Questions'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryFaqs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mb-8">
                ...
                <div class="space-y-4" x-data="{ openFaq: null }">
                    <?php $__currentLoopData = $categoryFaqs->sortBy('display_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                            <button @click="openFaq = openFaq === <?php echo e($faq->id); ?> ? null : <?php echo e($faq->id); ?>"
                            ...
                            <div x-show="openFaq === <?php echo e($faq->id); ?>" 
        ...
        <div class="mt-12 bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg shadow-lg p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('buyer.bug_reports.create')); ?>" 
                ...
                ?>
                <?php if($settings && $settings->admin_email): ?>
                    <a href="mailto:<?php echo e($settings->admin_email); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Downloads\laravel_project\resources\views/buyer/faq.blade.php ENDPATH**/ ?>